...
var (
	mapMarkerOpenSkySVG = []byte(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#0369a1" d="M12 3l9 14h-6l-3-5-3 5H3L12 3z"/></svg>`)
	mapMarkerAISStreamSVG = []byte(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#0f766e" d="M3 17c4-6 14-6 18 0H3zm3-3h12l-2-6H8l-2 6z"/></svg>`)
)
